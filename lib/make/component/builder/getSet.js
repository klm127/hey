...
/**
 * Mixin adds functions for changing scaffold props on a builder. builder.set.type.to for becomes a function which will set the type and return the builder
